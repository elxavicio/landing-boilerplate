          ...
          <Grid.Column textAlign="center">
            <Step.Group size="huge" stackable="mobile" widths={6}>
              <Step>
                <Icon name="check" />
                <Step.Content>
                  <Step.Title style={{ fontSize: "1em", marginBottom: "1em" }}>
                    Enable the app
                  </Step.Title>
                  <Step.Description
              ...
              <Step>
                ...
                <Step.Content>
                  ...
                  <Step.Description
                    style={{ fontSize: "0.8em", marginBottom: "1em" }}
                  >
                    If your laptop gets unplugged or the lid closes your laptop
                    will set up its volume to 200% and the alarm will play.
                  </Step.Description>
                </Step.Content>
              </Step>
              <Step>
